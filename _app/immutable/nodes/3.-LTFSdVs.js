import{B as e,H as t,J as n,K as r,Mt as i,Nt as a,T as o,U as s,W as c,Z as l,at as u,c as d,dt as f,et as p,ft as m,k as h,pt as g,z as _}from"../chunks/Cf3p9P98.js";import{c as v}from"../chunks/C7inyMw9.js";import"../chunks/v_jBEYI6.js";import{g as y}from"../chunks/BmqO0oI5.js";import{t as b}from"../chunks/NPqM7Ah4.js";import{s as x}from"../chunks/DUPB1P9s.js";import{t as S}from"../chunks/Dh8aeseQ.js";var C=r(`<a> </a>`),w=r(`<aside class="docs-toc svelte-vlvvjk" aria-label="Documentation table of contents"><div class="docs-toc-card svelte-vlvvjk"><div class="docs-toc-title svelte-vlvvjk">On this page</div> <nav class="docs-toc-nav svelte-vlvvjk"></nav></div></aside>`);function T(t,n){let r=d(n,`items`,24,()=>[]);var i=w(),m=f(i),v=g(f(m),2);_(v,5,r,e,(e,t)=>{var n=C();let r;var i=f(n,!0);a(n),u(()=>{r=h(n,1,`docs-toc-link svelte-vlvvjk`,null,r,{"docs-toc-link-level-2":(l(t).level??1)===2,"docs-toc-link-level-3":(l(t).level??1)===3}),o(n,`href`,(l(t),p(()=>l(t).href))),s(i,(l(t),p(()=>l(t).label)))}),c(e,n)}),a(v),a(m),a(i),c(t,i)}var E=r(`<li><i> </i><!> </li>`),D=r(`<tr><td> <br/> <code> </code></td><td> </td><td><ul class="param-list svelte-svpi39"></ul></td></tr>`),O=r(`<table class="table table-striped content-type-table"><thead><tr><th scope="col" class="name">Name</th><th scope="col" class="description svelte-svpi39">Description</th><th scope="col" class="parameters">Parameters</th></tr></thead><tbody></tbody></table>`);function k(r){var i=O(),o=g(f(i));_(o,5,()=>x,e,(r,i)=>{var o=D(),d=f(o),p=f(d),m=g(p,3),h=f(m,!0);a(m),a(d);var v=g(d),y=f(v,!0);a(v);var b=g(v),x=f(b);_(x,5,()=>l(i).params,e,(e,r)=>{var i=E(),o=f(i),d=f(o,!0);a(o);var p=g(o),m=e=>{var t=n();u(()=>s(t,` (${l(r).type??``})`)),c(e,t)};t(p,e=>{l(r).type&&e(m)});var h=g(p);a(i),u(()=>{s(d,l(r).name),s(h,`:
