import{B as e,H as t,J as n,K as r,Nt as i,Pt as a,T as o,U as s,W as c,Z as l,at as u,c as d,dt as f,et as p,ft as m,k as h,pt as g,z as _}from"../chunks/Be68hMco.js";import{c as v}from"../chunks/nY9PMJ3H.js";import"../chunks/D9FQP20W.js";import"../chunks/C02tyRh_.js";import{g as y}from"../chunks/CGIRNZUm.js";import{u as b}from"../chunks/Bj_FLGpu.js";import{t as x}from"../chunks/tZx0j95d.js";import{t as S}from"../chunks/CrDLK9V6.js";var C=r(`<a> </a>`),w=r(`<aside class="docs-toc svelte-vlvvjk" aria-label="Documentation table of contents"><div class="docs-toc-card svelte-vlvvjk"><div class="docs-toc-title svelte-vlvvjk">On this page</div> <nav class="docs-toc-nav svelte-vlvvjk"></nav></div></aside>`);function T(t,n){let r=d(n,`items`,24,()=>[]);var i=w(),m=f(i),v=g(f(m),2);_(v,5,r,e,(e,t)=>{var n=C();let r;var i=f(n,!0);a(n),u(()=>{r=h(n,1,`docs-toc-link svelte-vlvvjk`,null,r,{"docs-toc-link-level-2":(l(t).level??1)===2,"docs-toc-link-level-3":(l(t).level??1)===3}),o(n,`href`,(l(t),p(()=>l(t).href))),s(i,(l(t),p(()=>l(t).label)))}),c(e,n)}),a(v),a(m),a(i),c(t,i)}var E=r(`<li><i> </i><!> </li>`),D=r(`<tr><td> <br/> <code> </code></td><td> </td><td><ul class="param-list svelte-svpi39"></ul></td></tr>`),O=r(`<table class="table table-striped content-type-table"><thead><tr><th scope="col" class="name">Name</th><th scope="col" class="description svelte-svpi39">Description</th><th scope="col" class="parameters">Parameters</th></tr></thead><tbody></tbody></table>`);function k(r){var i=O(),o=g(f(i));_(o,5,()=>b,e,(r,i)=>{var o=D(),d=f(o),p=f(d),m=g(p,3),h=f(m,!0);a(m),a(d);var v=g(d),y=f(v,!0);a(v);var b=g(v),x=f(b);_(x,5,()=>l(i).params,e,(e,r)=>{var i=E(),o=f(i),d=f(o,!0);a(o);var p=g(o),m=e=>{var t=n();u(()=>s(t,` (${l(r).type??``})`)),c(e,t)};t(p,e=>{l(r).type&&e(m)});var h=g(p);a(i),u(()=>{s(d,l(r).name),s(h,`:
  ...
  "cards": [
    {
      ...
      "icon_back_top": "magic-swirl",
      "icon_back_bottom": "magic-swirl",
      "text_back": "1st Level",
...
}`,a(p);var _=g(p,12),b=f(_);b.textContent=`{
  "count": 1,
  "color": "#4a6898",
  "title": "Hex",
  "icon": "sparkles",
...
}`,a(_);var x=g(_,32);k(x,{});var S=g(x,4),C=f(S);C.textContent=`[
  {
    "type": "row",
...
]`,a(S);var w=g(S,4),T=f(w);T.textContent=`section | Traits
row
  column
